    ...
    return(
        <div className="w-full h-[calc(100vh-100px)] flex justify-center items-center ">
            <div className="w-[70%] h-full flex flex-col justify-center gap-6">
               <div className=" text-[35px] w-full md:w-[450px] text-[50px] font-bold">All your businesses, in one place.</div>
               <div className="text-[14px] md:w-[600px]  text-slate-400">Run your businesses without limitations; support customers, increase sales, and do more. For growing businesses and smart creators.🌿</div>
